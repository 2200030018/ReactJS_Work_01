...
import myImage from '../importa_images/My_id_photo.jpeg';

export default function Home() {
  return (
    <div className="max-w-screen-xl w-full mx-auto px-4">
      <div className="flex flex-col md:flex-row items-center justify-between py-16 text-white min-h-screen">
        {/* Left Content */}
        ...
        <div className="md:w-1/2 mt-10 md:mt-0 flex justify-center md:justify-end">
          <div className="relative w-80 h-80 md:w-96 md:h-96 rounded-full border-4 border-teal-400 shadow-[0_0_30px_rgba(236,72,153,0.6)] animate-pulse-glow">
            <img
              src={myImage}
              alt="Profile"
