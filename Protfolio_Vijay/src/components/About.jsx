...
import myImage1 from '../assets/my_image_jaket.jpg';
import { FaMapMarkerAlt, FaBook, FaUserTie } from 'react-icons/fa';

export default function About() {
  return (
    <div className="min-h-screen text-white p-8 flex flex-col md:flex-row items-center justify-between">
      {/* Left Content */}
      <div className="md:w-1/2 space-y-4">
        ...
        <p className="italic text-gray-400">Preferred name: <span className="text-indigo-300">Vijay Mandela</span> | Nickname: <span className="text-indigo-300">Vijay</span></p>
